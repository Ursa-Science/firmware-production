...
void MCO_TransmitPDO (
  uint16_t PDONr  // TPDO number to transmit
  );
...
void MCO_TriggerTPDO (
  uint16_t TPDONr  // TPDO number to transmit, as gTPDOConfig[] index
  );
#endif
...
*******************************************************************************/
void MCOUSER_Sleep (
  uint8_t node,     // node ID of the node who sent the message
