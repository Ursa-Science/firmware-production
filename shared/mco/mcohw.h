...
**************************************************************************/
uint8_t MCOHW_Init (
  uint16_t Bitrate    // Allowed values: 1000, 800, 500, 250, 125, 50, 25, 10
...
/**************************************************************************
DOES:    This function shuts down the CAN interface 
         (and transceiver where supported)
RETURNS: nothing
**************************************************************************/
void MCOHW_DeInit (
  void
...
uint8_t MCOHW_IsTimeExpired (
  uint16_t timestamp // Timestamp to be checked for expiration
  );
