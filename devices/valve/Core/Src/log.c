 ...
 * @note    All DBG_* macros in log.h route through Log_Write(),
 *          which enqueues formatted text into a 1 KB ring buffer.  The
 *          USART2 TXE ISR drains the buffer one byte per interrupt,
 *          giving zero-blocking behaviour.
 ******************************************************************************
 */
